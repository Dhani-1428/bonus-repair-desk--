...
export function StatsCards() {
  ...
  return (
    <div className="grid gap-4 sm:gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between pb-3 relative z-10 bg-blue-50 p-4 sm:p-6">
          <CardTitle className="text-xs sm:text-sm font-semibold text-black uppercase tracking-wide">
            {t("stats.totalDevices")}
          </CardTitle>
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-xl flex items-center justify-center shadow-md ring-2 ring-blue-200">
        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="text-3xl sm:text-4xl font-bold text-black mb-1">{stats.total}</div>
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between pb-3 relative z-10 bg-yellow-50 p-4 sm:p-6">
          <CardTitle className="text-xs sm:text-sm font-semibold text-black uppercase tracking-wide">
            {t("status.pending")}
          </CardTitle>
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-xl flex items-center justify-center shadow-md ring-2 ring-yellow-200">
        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="text-3xl sm:text-4xl font-bold text-black mb-1">{stats.pending}</div>
      ...
      >
        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="text-3xl sm:text-4xl font-bold text-black mb-1">{stats.notOk}</div>
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between pb-3 relative z-10 bg-green-50 p-4 sm:p-6">
          <CardTitle className="text-xs sm:text-sm font-semibold text-black uppercase tracking-wide">
            {t("status.completed")}
          </CardTitle>
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-xl flex items-center justify-center shadow-md ring-2 ring-green-200">
        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="text-3xl sm:text-4xl font-bold text-black mb-1">{stats.completed}</div>
      ...
      >
        ...
        <CardContent className="relative z-10 p-4 sm:p-6">
          <div className="text-3xl sm:text-4xl font-bold text-black mb-1">{stats.delivered}</div>
