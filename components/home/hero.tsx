          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <Link href="/register">
                  <div className="group cursor-pointer border border-gray-800/50 bg-gradient-to-r from-gray-900/50 to-black/50 backdrop-blur-sm gap-2 h-[60px] flex items-center p-[10px] rounded-full shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
                    <div className="border border-gray-700/50 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 h-[40px] rounded-full flex items-center justify-center text-white shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
