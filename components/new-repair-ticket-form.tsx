...
export function NewRepairTicketForm() {
  ...
  return (
    <div className="space-y-6">
      {!showTicketDetails ? (
        <Card className="shadow-2xl border border-blue-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
      <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-zinc-800 dark:to-zinc-800 border-b border-blue-200 dark:border-zinc-700 rounded-t-lg px-6 py-4">
      ...
      <CardContent className="p-6 text-black dark:text-white">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {devices.length > 0 && (
            <div className="grid gap-6 grid-cols-4 border-b border-blue-200 pb-6">
              <div className="space-y-3">
                <Label htmlFor="clientId" className="text-black dark:text-white text-base font-semibold">{t("receipt.clientId") || "Client ID"}</Label>
                {devices.length === 1 ? (
                  <div className="relative">
                    <Input
                      ...
                      className="!bg-white dark:!bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 text-black dark:text-white focus:border-blue-500 dark:focus:border-blue-600 h-12 text-lg font-mono"
                    />
                    <p className="text-xs text-gray-500 mt-1">{t("form.clientIdHintNew") || "Enter existing Client ID or leave for new client"}</p>
                  </div>
                ) : (
                  <div className="bg-white dark:bg-zinc-800 border border-blue-200 dark:border-zinc-700 rounded-md px-4 py-3 h-12 text-lg text-black dark:text-white flex items-center font-mono">
                    {clientId}
                  </div>
                )}
              </div>
              <div className="space-y-3">
                <Label htmlFor="customerName" className="text-black dark:text-white text-base font-semibold">{t("form.clientName")} *</Label>
                {devices.length === 1 ? (
                  <div className="relative">
                  <Input
                    id="customerName"
                    ...
                    required
                      className="!bg-white dark:!bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 text-black dark:text-white focus:border-blue-500 dark:focus:border-blue-600 h-12 text-lg"
                    />
                    {showClientSuggestions && searchExistingClients(customerName).length > 0 && (
                      <div className="absolute z-50 w-full mt-1 bg-white dark:bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 rounded-lg shadow-xl max-h-64 overflow-y-auto">
                        ...
                        {searchExistingClients(customerName).map((client: any, index: number) => (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="text-sm font-medium text-black dark:text-white">{client.customerName}</div>
                  ...
                  <div className="bg-white dark:bg-zinc-800 border border-blue-200 dark:border-zinc-700 rounded-md px-4 py-3 h-12 text-lg text-black dark:text-white flex items-center">
                    {customerName || t("common.notAvailable")}
                  </div>
                )}
              </div>
              <div className="space-y-3">
                <Label htmlFor="contact" className="text-black dark:text-white text-base font-semibold">{t("form.clientContact") || "Client Contact"}</Label>
                {devices.length === 1 ? (
                  <Input
                    id="contact"
                    type="tel"
              ...
              <div className="space-y-3">
                <Label htmlFor="receivedBy" className="text-black dark:text-white text-base font-semibold">{t("form.receivedBy")} *</Label>
                {devices.length === 1 ? (
                  <Input
                    id="receivedBy"
                    value={receivedBy}
          ...
          <div className="space-y-6">
            {devices.map((device, deviceIndex) => (
              <div
                ...
                className={`border-2 border-blue-200 dark:border-zinc-700 rounded-xl p-6 bg-white dark:bg-zinc-800 transition-all duration-300 ease-in-out ${
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-black dark:text-white">{t("form.device")} {deviceIndex + 1}</h3>
                  {devices.length > 1 && (
                    <Button
                      type="button"
                      variant="outline"
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label className="text-black dark:text-white">{t("form.brand")}</Label>
                    <div className="relative">
                      <Input
                        value={device.brand}
                        onChange={(e) => {
                        ...
                        className="!bg-white dark:!bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 text-black dark:text-white placeholder:text-black dark:placeholder:text-zinc-400 focus:border-blue-500 dark:focus:border-blue-600 pr-10"
                      />
                      <Popover>
                        ...
                        <PopoverContent className="bg-white dark:bg-zinc-800 border-gray-200 dark:border-zinc-700 w-[200px] p-1 max-h-[300px] overflow-y-auto">
                  ...
                  <div className="space-y-2">
                    <Label className="text-black dark:text-white">{t("form.model")}</Label>
                    <div className="relative">
                      <Input
                        value={device.model}
                        onChange={(e) => updateDevice(deviceIndex, "model", e.target.value)}
                        disabled={!device.brand}
                        className="!bg-white dark:!bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 text-black dark:text-white placeholder:text-black dark:placeholder:text-zinc-400 focus:border-blue-500 dark:focus:border-blue-600 pr-10 disabled:opacity-50"
                      />
                  ...
                  <div className="space-y-3">
                    <Label className="text-black dark:text-white text-base font-semibold">{t("form.imei")}</Label>
                    <Input
                      value={device.imeiNo}
                      onChange={(e) => updateDevice(deviceIndex, "imeiNo", e.target.value)}
                      maxLength={15}
                      inputMode="numeric"
                      className={`!bg-white dark:!bg-zinc-800 border-2 border-blue-200 dark:border-zinc-700 text-black dark:text-white placeholder:text-black dark:placeholder:text-zinc-400 focus:border-blue-500 dark:focus:border-blue-600 h-12 text-lg ${device.imeiError ? "border-red-500 focus-visible:ring-red-500" : ""}`}
                    />
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <p className="text-xs text-black dark:text-zinc-300">{t("form.laptopSerialNumberHint")}</p>
                  </div>

                  {/* Mobile Conditions (On Arrival) */}
                  <div className="space-y-2 md:col-span-2">
                    <Label className="text-black dark:text-white">Mobile Conditions (On Arrival)</Label>
                    <Textarea
                  ...
                  {/* Phone Issue */}
                  <div className="space-y-2 md:col-span-2">
                    <Label className="text-black dark:text-white">Phone Issue</Label>
                    <Textarea
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {/* 1. SIM Card */}
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 cursor-pointer transition-all">
                        <input
                          type="checkbox"
                          className="h-4 w-4 cursor-pointer bg-white dark:bg-zinc-800 border-blue-200 dark:border-zinc-700 text-blue-600 dark:text-blue-400 focus:ring-blue-500 dark:focus:ring-blue-600 rounded"
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.simCard")}</span>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 cursor-pointer transition-all">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.simTray")}</span>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 cursor-pointer transition-all">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.memoryCard")}</span>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 cursor-pointer transition-all">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.charger")}</span>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-blue-500 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-zinc-700 cursor-pointer transition-all">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.battery")}</span>
                        </div>
                      </label>
                      
                      {/* 6. Water Damaged */}
                      <label className="flex items-center gap-1.5 p-2 bg-white dark:bg-zinc-800 rounded border border-blue-200 dark:border-zinc-700 hover:border-red-500 dark:hover:border-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 cursor-pointer transition-all">
                        <input
                          type="checkbox"
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs font-medium text-black dark:text-white">{t("form.waterDamaged")}</span>
                        </div>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center items-start gap-20 md:col-span-2">
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <SelectTrigger className="w-[120px] !bg-white dark:!bg-zinc-800 border-2 border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white">
                            <SelectValue />
                          </SelectTrigger>
                        ...
                        <div className="relative w-32">
                          ...
                          <Input
                            ...
                            className="!bg-white dark:!bg-zinc-800 border-2 border-gray-300 dark:border-zinc-700 text-gray-900 dark:text-white placeholder:text-black dark:placeholder:text-zinc-400 focus:border-blue-500 dark:focus:border-blue-600 pl-8 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                          />
                        </div>
                      </div>
                    </div>
                    <div className="flex items-end">
                      <label className="flex items-center gap-2 text-sm text-black dark:text-white hover:text-black dark:hover:text-white cursor-pointer mt-6">
                        <input
                          type="checkbox"
                          className="h-4 w-4 cursor-pointer bg-white dark:bg-zinc-800 border-blue-200 dark:border-zinc-700 text-blue-600 dark:text-blue-400 focus:ring-blue-500 dark:focus:ring-blue-600 rounded"
          ...
          <div className="flex items-center justify-end pt-4 border-t border-gray-200">
            <div className="flex gap-4">
              <Button type="button" variant="outline" onClick={() => router.push("/dashboard")} className="px-8 border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-zinc-700">
                {t("form.cancel")}
              </Button>
              <Button 
                type="submit" 
        ...
        <Card className="shadow-2xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900">
          <CardHeader className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-zinc-800 dark:to-zinc-800 border-b border-gray-200 dark:border-zinc-700 rounded-t-lg px-6 py-4">
          ...
          <CardContent className="p-6 text-black space-y-6">
            {createdTicketsDetails && createdTicketsDetails.length > 0 ? (
              ...
              return (
                <div key={ticket?.id || index} className="border-2 border-blue-200 dark:border-zinc-700 rounded-xl p-6 bg-white dark:bg-zinc-800 space-y-4">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-black dark:text-white">Device {index + 1}</h3>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        <div><span className="text-black dark:text-white">Repair Number:</span> <span className="text-black dark:text-white font-mono">{ticket?.repairNumber || "N/A"}</span></div>
                        {ticket?.spu && <div><span className="text-black dark:text-white">SPU:</span> <span className="text-black dark:text-white">{ticket.spu}</span></div>}
                        <div><span className="text-black dark:text-white">Entry Date:</span> <span className="text-black dark:text-white">{ticket?.createdAt ? new Date(ticket.createdAt).toLocaleString() : "N/A"}</span></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-sm">
                        <div><span className="text-black dark:text-white">{t("form.clientName")}:</span> <span className="text-black dark:text-white">{ticket?.customerName || "N/A"}</span></div>
...
function translateProblemForReceipt(problem: string | null | undefined, lang: ReceiptLanguage): string {
  ...
  const problemMap: Record<string, string> = {
    ...
    "both sides": "problem.networkIssue",
    "jack is broken": "problem.chargingIssue",
    "jack broken": "problem.chargingIssue",
    "jack is not working": "problem.chargingIssue",
    "jack not working": "problem.chargingIssue",
    "charging jack broken": "problem.chargingIssue",
    "charging jack is broken": "problem.chargingIssue",
    ...
    "problema de rede": "problem.networkIssue",
    "problema rede": "problem.networkIssue",
    "rede problema": "problem.networkIssue",
    "ambos os lados": "problem.networkIssue",
    "ambos lados": "problem.networkIssue",
...
function translateServicesForReceipt(services: string | string[] | null | undefined, lang: ReceiptLanguage): string {
  ...
  const serviceMap: Record<string, string> = {
    ...
    "charging jack repaired": "service.chargingPort",
...
function getReceiptTranslations(lang: ReceiptLanguage = "en") {
  const translations: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      "receipt.problem": "Problem",
      "receipt.mobileCondition": "Mobilzustand (Bei Ankunft)",
      "receipt.price": "Budget",
      // Service names
      "service.lcd": "LCD",
      ...
      "problem.waterDamaged": "Durch Wasser Beschädigt",
      ...
      "problem.powerButtonNotWorking": "Einschaltknopf Funktioniert Nicht",
    ...
    fr: {
      ...
      "problem.softwareIssue": "Problème de Logiciel",
    ...
    ur: {
      ...
      "problem.wontTurnOn": "آن نہیں ہوگا",
      "problem.dead": "مر گیا",
      "problem.deadRepair": "مر گیا / آن نہیں ہوگا",
    ...
    it: {
      ...
      "receipt.adminCopy": "COPIA AMMINISTRATORE",
      "receipt.clientId": "ID Cliente",
      "receipt.name": "Nome",
      "receipt.clientPhone": "Telefono Cliente",
      "receipt.receivedBy": "Dispositivo Ricevuto Da",
      "receipt.entryDate": "Data di Entrata",
      "receipt.outDate": "Data di Uscita",
      "receipt.repairN": "Riparazione n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Marca-Modello",
      "receipt.laptopSerialN": "Numero di Serie Laptop",
      "receipt.warranty": "Garanzia",
      "receipt.equipmentCheck": "Controllo Attrezzatura",
      "receipt.equipmentObs": "Oss. Attrezzatura",
      "receipt.repairObs": "Oss. Riparazione",
      "receipt.services": "Servizi",
      "receipt.problem": "Problema",
      "receipt.mobileCondition": "Condizione Mobile (All'Arrivo)",
      "receipt.price": "Preventivo",
      "receipt.responsibleText": "SIAMO RESPONSABILI PER L'ASSISTENZA / RIPARAZIONE DELLE ANOMALIE DESCRITTE.",
      "receipt.storageTitle": "Condizioni di Stoccaggio e Ritiro",
      "receipt.storageText1": "L'attrezzatura deve essere ritirata entro un massimo di sessanta (60) giorni dopo il completamento della riparazione e la relativa notifica da",
      "receipt.storageText2": "Scaduto questo termine, verrà applicata una tariffa di stoccaggio di 0,95 € al giorno, a partire dal 61° giorno, fino al limite massimo di centoventi (120) giorni, applicabile indipendentemente dal fatto che la riparazione sia stata eseguita o che il preventivo sia stato rifiutato.",
      "receipt.storageText3": "Accettando questo documento, il cliente dichiara di aver letto, compreso e accettato i termini e le condizioni di riparazione.",
      "receipt.repairReference": "Riferimento Riparazione",
      "receipt.cutHere": "TAGLIARE QUI",
      "common.yes": "Sì",
      "common.no": "No",
      "form.warrantyUntil30Days": "Garanzia fino a 30 giorni",
      "form.withoutWarranty": "Senza Garanzia",
      "form.simCard": "Carta SIM",
      "form.simTray": "Vassoio SIM",
      "form.memoryCard": "Scheda di Memoria",
      "form.charger": "Caricatore",
      "form.battery": "Batteria",
      "form.waterDamaged": "Danneggiato dall'Acqua",
      "form.price": "Prezzo",
    ...
    nl: {
      ...
      "receipt.adminCopy": "ADMIN KOPIE",
      "receipt.clientId": "Klant ID",
      "receipt.name": "Naam",
      "receipt.clientPhone": "Klant Telefoon",
      "receipt.receivedBy": "Apparaat Ontvangen Door",
      "receipt.entryDate": "Inkomdatum",
      "receipt.outDate": "Uitgangsdatum",
      "receipt.repairN": "Reparatie n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Merk-Model",
      "receipt.laptopSerialN": "Laptop Serienummer",
      "receipt.warranty": "Garantie",
      "receipt.equipmentCheck": "Uitrustingscontrole",
      "receipt.equipmentObs": "Uitrusting Obs.",
      "receipt.repairObs": "Reparatie Obs.",
      "receipt.services": "Diensten",
      "receipt.problem": "Probleem",
      "receipt.mobileCondition": "Mobiele Conditie (Bij Aankomst)",
      "receipt.price": "Begroting",
      "receipt.responsibleText": "WIJ ZIJN VERANTWOORDELIJK VOOR DE ASSISTENTIE / REPARATIE VAN DE BESCHREVEN AFWIJKINGEN.",
      "receipt.storageTitle": "Opslag- en Ophaalvoorwaarden",
      "receipt.storageText1": "Het apparaat moet binnen zestig (60) dagen na voltooiing van de reparatie en de bijbehorende kennisgeving door",
      "receipt.storageText2": "worden opgehaald. Na deze termijn wordt vanaf de 61e dag een opslagkosten van 0,95 € per dag toegepast, tot een maximum van honderdtwintig (120) dagen, van toepassing ongeacht of de reparatie is uitgevoerd of dat de begroting is geweigerd.",
      "receipt.storageText3": "Door dit document te accepteren, verklaart de klant dat hij de reparatievoorwaarden heeft gelezen, begrepen en geaccepteerd.",
      "receipt.repairReference": "Reparatie Referentie",
      "receipt.cutHere": "HIER SNIJDEN",
      "common.yes": "Ja",
      "common.no": "Nee",
      "form.warrantyUntil30Days": "Garantie tot 30 dagen",
      "form.withoutWarranty": "Zonder Garantie",
      "form.simCard": "SIM Kaart",
      "form.simTray": "SIM Lade",
      "form.memoryCard": "Geheugenkaart",
      "form.charger": "Oplader",
      "form.battery": "Batterij",
      "form.waterDamaged": "Beschadigd door Water",
      "form.price": "Prijs",
    ...
    pl: {
      ...
      "receipt.adminCopy": "KOPIA ADMINISTRATORA",
      "receipt.clientId": "ID Klienta",
      "receipt.name": "Nazwa",
      "receipt.clientPhone": "Telefon Klienta",
      "receipt.receivedBy": "Urządzenie Otrzymane Przez",
      "receipt.entryDate": "Data Wejścia",
      "receipt.outDate": "Data Wyjścia",
      "receipt.repairN": "Naprawa n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Marka-Model",
      "receipt.laptopSerialN": "Numer Seryjny Laptopa",
      "receipt.warranty": "Gwarancja",
      "receipt.equipmentCheck": "Kontrola Sprzętu",
      "receipt.equipmentObs": "Obs. Sprzętu",
      "receipt.repairObs": "Obs. Naprawy",
      "receipt.services": "Usługi",
      "receipt.problem": "Problem",
      "receipt.mobileCondition": "Stan Telefonu (Przy Przyjęciu)",
      "receipt.price": "Budżet",
      "receipt.responsibleText": "JESTEŚMY ODPOWIEDZIALNI ZA POMOC / NAPRAWĘ OPISANYCH ANOMALII.",
      "receipt.storageTitle": "Warunki Przechowywania i Odbioru",
      "receipt.storageText1": "Urządzenie musi zostać odebrane w ciągu sześćdziesięciu (60) dni od zakończenia naprawy i odpowiedniego powiadomienia przez",
      "receipt.storageText2": "Po upływie tego terminu, od 61. dnia zostanie zastosowana opłata za przechowywanie w wysokości 0,95 € dziennie, do maksymalnego limitu stu dwudziestu (120) dni, obowiązująca niezależnie od tego, czy naprawa została wykonana, czy budżet został odrzucony.",
      "receipt.storageText3": "Przyjmując ten dokument, klient oświadcza, że przeczytał, zrozumiał i zaakceptował warunki i zasady naprawy.",
      "receipt.repairReference": "Referencja Naprawy",
      "receipt.cutHere": "PRZETNIJ TUTAJ",
      "common.yes": "Tak",
      "common.no": "Nie",
      "form.warrantyUntil30Days": "Gwarancja do 30 dni",
      "form.withoutWarranty": "Bez Gwarancji",
      "form.simCard": "Karta SIM",
      "form.simTray": "Szafka SIM",
      "form.memoryCard": "Karta Pamięci",
      "form.charger": "Ładowarka",
      "form.battery": "Bateria",
      "form.waterDamaged": "Uszkodzone przez Wodę",
      "form.price": "Cena",
      "form.budget": "Budżet",
    ...
    ro: {
      "receipt.clientCopy": "COPIE CLIENT",
      "receipt.adminCopy": "COPIE ADMINISTRATOR",
      "receipt.clientId": "ID Client",
      "receipt.name": "Nume",
      "receipt.clientPhone": "Telefon Client",
      "receipt.receivedBy": "Dispozitiv Primit De",
      "receipt.entryDate": "Data Intrării",
      "receipt.outDate": "Data Ieșirii",
      "receipt.repairN": "Reparație n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Marcă-Model",
      "receipt.laptopSerialN": "Număr de Serie Laptop",
      "receipt.warranty": "Garanție",
      "receipt.equipmentCheck": "Verificare Echipament",
      "receipt.equipmentObs": "Obs. Echipament",
      "receipt.repairObs": "Obs. Reparație",
      "receipt.services": "Servicii",
      "receipt.problem": "Problemă",
      "receipt.mobileCondition": "Condiție Mobilă (La Sosire)",
      "receipt.price": "Buget",
      "receipt.responsibleText": "SUNTEM RESPONSABILI PENTRU ASISTENȚA / REPARAȚIA ANOMALIILOR DESCRISE.",
      "receipt.storageTitle": "Condiții de Depozitare și Ridicare",
      "receipt.storageText1": "Echipamentul trebuie să fie ridicat în termen de maximum șaizeci (60) de zile după finalizarea reparației și notificarea corespunzătoare de către",
      "receipt.storageText2": "După expirarea acestui termen, se va aplica o taxă de depozitare de 0,95 € pe zi, începând cu ziua 61, până la limita maximă de o sută douăzeci (120) de zile, aplicabilă indiferent dacă reparația a fost efectuată sau dacă bugetul a fost respins.",
      "receipt.storageText3": "Prin acceptarea acestui document, clientul declară că a citit, a înțeles și acceptă termenii și condițiile de reparație.",
      "receipt.repairReference": "Referință Reparație",
      "receipt.cutHere": "TAIE AICI",
      "common.yes": "Da",
      "common.no": "Nu",
      "form.warrantyUntil30Days": "Garanție până la 30 de zile",
      "form.withoutWarranty": "Fără Garanție",
      "form.simCard": "Card SIM",
      "form.simTray": "Tava SIM",
      "form.memoryCard": "Card de Memorie",
      "form.charger": "Încărcător",
      "form.battery": "Baterie",
      "form.waterDamaged": "Avariat de Apă",
      "form.price": "Preț",
      "form.budget": "Buget",
    ...
    el: {
      ...
      "receipt.adminCopy": "ΑΝΤΙΓΡΑΦΟ ΔΙΑΧΕΙΡΙΣΤΗ",
      "receipt.clientId": "Ταυτότητα Πελάτη",
      "receipt.name": "Όνομα",
      "receipt.clientPhone": "Τηλέφωνο Πελάτη",
      "receipt.receivedBy": "Συσκευή Λήφθηκε Από",
      "receipt.entryDate": "Ημερομηνία Εισόδου",
      "receipt.outDate": "Ημερομηνία Εξόδου",
      "receipt.repairN": "Επισκευή n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Μάρκα-Μοντέλο",
      "receipt.laptopSerialN": "Σειριακός Αριθμός Laptop",
      "receipt.warranty": "Εγγύηση",
      "receipt.equipmentCheck": "Έλεγχος Εξοπλισμού",
      "receipt.equipmentObs": "Παρατήρηση Εξοπλισμού",
      "receipt.repairObs": "Παρατήρηση Επισκευής",
      "receipt.services": "Υπηρεσίες",
      "receipt.problem": "Πρόβλημα",
      "receipt.mobileCondition": "Κατάσταση Κινητού (Στην Άφιξη)",
      "receipt.price": "Προϋπολογισμός",
      "receipt.responsibleText": "ΕΙΜΑΣΤΕ ΥΠΕΥΘΥΝΟΙ ΓΙΑ ΤΗΝ ΒΟΗΘΕΙΑ / ΕΠΙΣΚΕΥΗ ΤΩΝ ΠΕΡΙΓΡΑΦΟΜΕΝΩΝ ΑΝΩΜΑΛΙΩΝ.",
      "receipt.storageTitle": "Όροι Αποθήκευσης και Ανάληψης",
      "receipt.storageText1": "Ο εξοπλισμός πρέπει να παραληφθεί εντός εξήντα (60) ημερών από την ολοκλήρωση της επισκευής και την αντίστοιχη ειδοποίηση από",
      "receipt.storageText2": "Μετά τη λήξη αυτής της προθεσμίας, θα εφαρμοστεί χρέωση αποθήκευσης 0,95 € ανά ημέρα, από την 61η ημέρα, έως το μέγιστο όριο εκατόν είκοσι (120) ημερών, εφαρμοστέο ανεξάρτητα από το αν η επισκευή έχει πραγματοποιηθεί ή αν ο προϋπολογισμός έχει απορριφθεί.",
      "receipt.storageText3": "Με την αποδοχή αυτού του εγγράφου, ο πελάτης δηλώνει ότι έχει διαβάσει, κατανοήσει και αποδεχτεί τους όρους και τις προϋποθέσεις επισκευής.",
      "receipt.repairReference": "Αναφορά Επισκευής",
      "receipt.cutHere": "ΚΟΨΕ ΕΔΩ",
      "common.yes": "Ναι",
      "common.no": "Όχι",
      "form.warrantyUntil30Days": "Εγγύηση έως 30 ημέρες",
      "form.withoutWarranty": "Χωρίς Εγγύηση",
      "form.simCard": "Κάρτα SIM",
      "form.simTray": "Δίσκος SIM",
      "form.memoryCard": "Κάρτα Μνήμης",
      "form.charger": "Φορτιστής",
      "form.battery": "Μπαταρία",
      "form.waterDamaged": "Κατεστραμμένο από Νερό",
      "form.price": "Τιμή",
    ...
    cs: {
      ...
      "receipt.adminCopy": "KOPIE SPRÁVCE",
      "receipt.clientId": "ID Klienta",
      "receipt.name": "Jméno",
      "receipt.clientPhone": "Telefon Klienta",
      "receipt.receivedBy": "Zařízení Přijato Od",
      "receipt.entryDate": "Datum Vstupu",
      "receipt.outDate": "Datum Výstupu",
      "receipt.repairN": "Oprava n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Značka-Model",
      "receipt.laptopSerialN": "Sériové Číslo Laptopu",
      "receipt.warranty": "Záruka",
      "receipt.equipmentCheck": "Kontrola Zařízení",
      "receipt.equipmentObs": "Pozn. Zařízení",
      "receipt.repairObs": "Pozn. Opravy",
      "receipt.services": "Služby",
      "receipt.problem": "Problém",
      "receipt.mobileCondition": "Stav Mobilu (Při Příjmu)",
      "receipt.price": "Rozpočet",
      "receipt.responsibleText": "JSME ODPOVĚDNÍ ZA ASISTENCI / OPRAVU POPSANÝCH ANOMÁLIÍ.",
      "receipt.storageTitle": "Podmínky Skladování a Vyzvednutí",
      "receipt.storageText1": "Zařízení musí být vyzvednuto do šedesáti (60) dnů od dokončení opravy a odpovídajícího oznámení od",
      "receipt.storageText2": "Po uplynutí této lhůty bude od 61. dne účtován poplatek za skladování ve výši 0,95 € denně, až do maximálního limitu sto dvaceti (120) dnů, platný bez ohledu na to, zda byla oprava provedena nebo zda byl rozpočet zamítnut.",
      "receipt.storageText3": "Přijetím tohoto dokumentu klient prohlašuje, že přečetl, porozuměl a přijal podmínky a zásady opravy.",
      "receipt.repairReference": "Odkaz na Opravu",
      "receipt.cutHere": "ŘEZNĚTE ZDE",
      "common.yes": "Ano",
      "common.no": "Ne",
      "form.warrantyUntil30Days": "Záruka do 30 dnů",
      "form.withoutWarranty": "Bez Záruky",
      "form.simCard": "SIM Karta",
      "form.simTray": "SIM Zásobník",
      "form.memoryCard": "Paměťová Karta",
      "form.charger": "Nabíječka",
      "form.battery": "Baterie",
      "form.waterDamaged": "Poškozeno Vodou",
      "form.price": "Cena",
    ...
    hu: {
      ...
      "receipt.adminCopy": "ADMIN MÁSOLAT",
      "receipt.clientId": "Ügyfél ID",
      "receipt.name": "Név",
      "receipt.clientPhone": "Ügyfél Telefon",
      "receipt.receivedBy": "Eszköz Átvéve Által",
      "receipt.entryDate": "Belépési Dátum",
      "receipt.outDate": "Kilépési Dátum",
      "receipt.repairN": "Javítás n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Márka-Modell",
      "receipt.laptopSerialN": "Laptop Sorozatszám",
      "receipt.warranty": "Garancia",
      "receipt.equipmentCheck": "Felszerelés Ellenőrzés",
      "receipt.equipmentObs": "Felszerelés Megj.",
      "receipt.repairObs": "Javítás Megj.",
      "receipt.services": "Szolgáltatások",
      "receipt.problem": "Probléma",
      "receipt.mobileCondition": "Mobil Állapot (Érkezéskor)",
      "receipt.price": "Költségvetés",
      "receipt.responsibleText": "FELELŐSEK VAGYUNK A LEÍRT ANOMÁLIÁK SEGÍTSÉGÉÉRT / JAVÍTÁSÁÉRT.",
      "receipt.storageTitle": "Tárolási és Átvételi Feltételek",
      "receipt.storageText1": "A felszerelést hatvan (60) napon belül kell átvenni a javítás befejezése és a megfelelő értesítés után",
      "receipt.storageText2": "E határidő lejárta után a 61. naptól kezdődően napi 0,95 € tárolási díjat számítunk fel, legfeljebb százhúsz (120) napig, függetlenül attól, hogy a javítás megtörtént-e vagy a költségvetést elutasították-e.",
      "receipt.storageText3": "A dokumentum elfogadásával az ügyfél kijelenti, hogy elolvasta, megértette és elfogadta a javítási feltételeket és szabályokat.",
      "receipt.repairReference": "Javítás Hivatkozás",
      "receipt.cutHere": "VÁGJON ITT",
      "common.yes": "Igen",
      "common.no": "Nem",
      "form.warrantyUntil30Days": "Garancia 30 napig",
      "form.withoutWarranty": "Garancia Nélkül",
      "form.simCard": "SIM Kártya",
      "form.simTray": "SIM Tálca",
      "form.memoryCard": "Memóriakártya",
      "form.charger": "Töltő",
      "form.battery": "Akkumulátor",
      "form.waterDamaged": "Víz által Károsított",
      "form.price": "Ár",
    ...
    sv: {
      ...
      "receipt.adminCopy": "ADMIN KOPIA",
      "receipt.clientId": "Kund ID",
      "receipt.name": "Namn",
      "receipt.clientPhone": "Kundtelefon",
      "receipt.receivedBy": "Enhet Mottagen Av",
      "receipt.entryDate": "Ingångsdatum",
      "receipt.outDate": "Utgångsdatum",
      "receipt.repairN": "Reparation n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Varumärke-Modell",
      "receipt.laptopSerialN": "Laptop Serienummer",
      "receipt.warranty": "Garanti",
      "receipt.equipmentCheck": "Utrustningskontroll",
      "receipt.equipmentObs": "Utrustning Obs.",
      "receipt.repairObs": "Reparation Obs.",
      "receipt.services": "Tjänster",
      "receipt.problem": "Problem",
      "receipt.mobileCondition": "Mobil Tillstånd (Vid Ankomst)",
      "receipt.price": "Budget",
      "receipt.responsibleText": "VI ÄR ANSVARIGA FÖR ASSISTANS / REPARATION AV DE BESKRIVNA AVVIKELSERNA.",
      "receipt.storageTitle": "Lagrings- och Hämtningsvillkor",
      "receipt.storageText1": "Utrustningen måste hämtas inom sextio (60) dagar efter slutförandet av reparationen och motsvarande meddelande från",
      "receipt.storageText2": "Efter denna tidsperiod kommer en lagringsavgift på 0,95 € per dag att tillämpas från dag 61, upp till en maximal gräns på hundratjugo (120) dagar, tillämplig oavsett om reparationen har utförts eller om budgeten har avvisats.",
      "receipt.storageText3": "Genom att acceptera detta dokument förklarar kunden att de har läst, förstått och accepterat villkoren och reglerna för reparation.",
      "receipt.repairReference": "Reparationsreferens",
      "receipt.cutHere": "SKÄR HÄR",
      "common.yes": "Ja",
      "common.no": "Nej",
      "form.warrantyUntil30Days": "Garanti upp till 30 dagar",
      "form.withoutWarranty": "Utan Garanti",
      "form.simCard": "SIM Kort",
      "form.simTray": "SIM Fack",
      "form.memoryCard": "Minneskort",
      "form.charger": "Laddare",
      "form.battery": "Batteri",
      "form.waterDamaged": "Skadad av Vatten",
      "form.price": "Pris",
      "form.budget": "Budget",
      ...
      "receipt.adminCopy": "ADMIN KOPIO",
      "receipt.clientId": "Asiakas ID",
      "receipt.name": "Nimi",
      "receipt.clientPhone": "Asiakas Puhelin",
      "receipt.receivedBy": "Laite Vastaanotettu",
      "receipt.entryDate": "Saapumispäivä",
      "receipt.outDate": "Lähtöpäivä",
      "receipt.repairN": "Korjaus n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Merkki-Malli",
      "receipt.laptopSerialN": "Kannettavan Sarjanumero",
      "receipt.warranty": "Takuu",
      "receipt.equipmentCheck": "Laitteiden Tarkistus",
      "receipt.equipmentObs": "Laitteet Huom.",
      "receipt.repairObs": "Korjaus Huom.",
      "receipt.services": "Palvelut",
      "receipt.problem": "Ongelma",
      "receipt.mobileCondition": "Mobiilin Tila (Saapuessa)",
      "receipt.price": "Budjetti",
      "receipt.responsibleText": "VASTAAMME KUVATTUJEN POIKKEAMIEN AVUSTUKSESTA / KORJAUKSESTA.",
      "receipt.storageTitle": "Varastoinnin ja Noutamisen Ehdot",
      "receipt.storageText1": "Laitteet on noudettava kuudessakymmenessä (60) päivässä korjauksen valmistumisen ja vastaavan ilmoituksen jälkeen",
      "receipt.storageText2": "Tämän ajanjakson jälkeen sovelletaan varastointimaksua 0,95 € päivässä 61. päivästä alkaen, enintään sata kaksikymmentä (120) päivää, riippumatta siitä, onko korjaus suoritettu vai onko budjetti hylätty.",
      "receipt.storageText3": "Hyväksymällä tämän asiakirjan asiakas vahvistaa, että he ovat lukeneet, ymmärtäneet ja hyväksyneet korjausehdot ja säännöt.",
      "receipt.repairReference": "Korjausviite",
      "receipt.cutHere": "LEIKKAA TÄÄLLÄ",
      "common.yes": "Kyllä",
      "common.no": "Ei",
      "form.warrantyUntil30Days": "Takuu 30 päivään",
      "form.withoutWarranty": "Ilman Takuuta",
      "form.simCard": "SIM Kortti",
      "form.simTray": "SIM Kotelo",
      "form.memoryCard": "Muistikortti",
      "form.charger": "Laturi",
      "form.battery": "Akku",
      "form.waterDamaged": "Veden Vaurioittama",
      "form.price": "Hinta",
    ...
    da: {
      ...
      "receipt.adminCopy": "ADMIN KOPI",
      "receipt.clientId": "Klient ID",
      "receipt.name": "Navn",
      "receipt.clientPhone": "Klienttelefon",
      "receipt.receivedBy": "Enhed Modtaget Af",
      "receipt.entryDate": "Indgangsdato",
      "receipt.outDate": "Udgångsdato",
      "receipt.repairN": "Reparation n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Mærke-Model",
      "receipt.laptopSerialN": "Laptop Serienummer",
      "receipt.warranty": "Garanti",
      "receipt.equipmentCheck": "Udstyrskontrol",
      "receipt.equipmentObs": "Udstyr Obs.",
      "receipt.repairObs": "Reparation Obs.",
      "receipt.services": "Tjenester",
      "receipt.problem": "Problem",
      "receipt.mobileCondition": "Mobil Tilstand (Ved Ankomst)",
      "receipt.price": "Budget",
      "receipt.responsibleText": "VI ER ANSVARLIGE FOR ASSISTENCEN / REPARATIONEN AF DE BESKRIVEDE UNORMALITETER.",
      "receipt.storageTitle": "Opbevarings- og Afhentningsbetingelser",
      "receipt.storageText1": "Udstyret skal afhentes inden for tres (60) dage efter afslutningen af reparationen og den tilsvarende meddelelse fra",
      "receipt.storageText2": "Efter denne periode vil der blive pålagt et opbevaringsgebyr på 0,95 € pr. dag fra dag 61, op til en maksimal grænse på hundrede tyve (120) dage, uanset om reparationen er blevet udført eller om budgettet er blevet afvist.",
      "receipt.storageText3": "Ved at acceptere dette dokument erklærer kunden, at de har læst, forstået og accepteret betingelserne og reglerne for reparation.",
      "receipt.repairReference": "Reparationsreference",
      "receipt.cutHere": "KLIP HER",
      "common.yes": "Ja",
      "common.no": "Nej",
      "form.warrantyUntil30Days": "Garanti op til 30 dage",
      "form.withoutWarranty": "Uden Garanti",
      "form.simCard": "SIM Kort",
      "form.simTray": "SIM Skuffe",
      "form.memoryCard": "Hukommelseskort",
      "form.charger": "Oplader",
      "form.battery": "Batteri",
      "form.waterDamaged": "Skadet af Vand",
      "form.price": "Pris",
      "form.budget": "Budget",
    ...
    bg: {
      ...
      "receipt.adminCopy": "АДМИН КОПИЕ",
      "receipt.clientId": "ID на клиент",
      "receipt.name": "Име",
      "receipt.clientPhone": "Телефон на клиент",
      "receipt.receivedBy": "Устройство получено от",
      "receipt.entryDate": "Дата на влизане",
      "receipt.outDate": "Дата на излизане",
      "receipt.repairN": "Ремонт n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Марка-Модел",
      "receipt.laptopSerialN": "Сериен номер на лаптоп",
      "receipt.warranty": "Гаранция",
      "receipt.equipmentCheck": "Проверка на оборудване",
      "receipt.equipmentObs": "Набл. оборудване",
      "receipt.repairObs": "Набл. ремонт",
      "receipt.services": "Услуги",
      "receipt.problem": "Проблем",
      "receipt.mobileCondition": "Състояние на мобилен (при пристигане)",
      "receipt.price": "Бюджет",
      "receipt.responsibleText": "НИЕ СМЕ ОТГОВОРНИ ЗА АСИСТЕНЦИЯТА / РЕМОНТА НА ОПИСАНИТЕ АНОМАЛИИ.",
      "receipt.storageTitle": "Условия за съхранение и получаване",
      "receipt.storageText1": "Оборудването трябва да бъде получено в срок от шестдесет (60) дни след завършване на ремонта и съответното уведомление от",
      "receipt.storageText2": "След изтичане на този срок ще се прилага такса за съхранение от 0,95 € на ден, започвайки от 61-вия ден, до максимален лимит от сто двадесет (120) дни, приложимо независимо дали ремонтът е извършен или бюджетът е отхвърлен.",
      "receipt.storageText3": "При приемане на този документ клиентът декларира, че е прочел, разбрал и приел условията и правилата за ремонт.",
      "receipt.repairReference": "Референция за ремонт",
      "receipt.cutHere": "РЕЖЕТЕ ТУК",
      "common.yes": "Да",
      "common.no": "Не",
      "form.warrantyUntil30Days": "Гаранция до 30 дни",
      "form.withoutWarranty": "Без гаранция",
      "form.simCard": "SIM карта",
      "form.simTray": "SIM тава",
      "form.memoryCard": "Карта памет",
      "form.charger": "Зареждащо устройство",
      "form.battery": "Батерия",
      "form.waterDamaged": "Повредено от вода",
      "form.price": "Цена",
      "form.budget": "Бюджет",
    ...
    hr: {
      ...
      "receipt.adminCopy": "KOPIJA ADMINISTRATORA",
      "receipt.clientId": "ID Klijenta",
      "receipt.name": "Ime",
      "receipt.clientPhone": "Telefon Klijenta",
      "receipt.receivedBy": "Uređaj Primljen Od",
      "receipt.entryDate": "Datum Ulaska",
      "receipt.outDate": "Datum Izlaska",
      "receipt.repairN": "Popravak n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Marka-Model",
      "receipt.laptopSerialN": "Serijski Broj Laptopa",
      "receipt.warranty": "Garancija",
      "receipt.equipmentCheck": "Provjera Opreme",
      "receipt.equipmentObs": "Oprema Nap.",
      "receipt.repairObs": "Popravak Nap.",
      "receipt.services": "Usluge",
      "receipt.problem": "Problem",
      "receipt.mobileCondition": "Stanje Mobitela (Pri Dolasku)",
      "receipt.price": "Proračun",
      "receipt.responsibleText": "ODGOVORNI SMO ZA POMOC / POPRAVAK OPISANIH ANOMALIJA.",
      "receipt.storageTitle": "Uvjeti Skladištenja i Preuzimanja",
      "receipt.storageText1": "Oprema mora biti preuzeta u roku od šezdeset (60) dana nakon završetka popravka i odgovarajuće obavijesti od",
      "receipt.storageText2": "Nakon isteka ovog roka, primjenjivat će se naknada za skladištenje od 0,95 € po danu, počevši od 61. dana, do maksimalnog ograničenja od sto dvadeset (120) dana, primjenjivo neovisno o tome je li popravak izvršen ili je proračun odbijen.",
      "receipt.storageText3": "Prihvaćanjem ovog dokumenta klijent izjavljuje da je pročitao, razumio i prihvatio uvjete i pravila popravka.",
      "receipt.repairReference": "Referenca Popravka",
      "receipt.cutHere": "REŽITE OVDJE",
      "common.yes": "Da",
      "common.no": "Ne",
      "form.warrantyUntil30Days": "Garancija do 30 dana",
      "form.withoutWarranty": "Bez Garancije",
      "form.simCard": "SIM Kartica",
      "form.simTray": "SIM Ladica",
      "form.memoryCard": "Memorijska Kartica",
      "form.charger": "Punjač",
      "form.battery": "Baterija",
      "form.waterDamaged": "Oštećeno Vodom",
      "form.price": "Cijena",
    ...
    sk: {
      ...
      "receipt.adminCopy": "KÓPIA SPRÁVICU",
      "receipt.clientId": "ID Klienta",
      "receipt.name": "Meno",
      "receipt.clientPhone": "Telefón Klienta",
      "receipt.receivedBy": "Zariadenie Prijaté Od",
      "receipt.entryDate": "Dátum Vstupu",
      "receipt.outDate": "Dátum Výstupu",
      "receipt.repairN": "Oprava n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Značka-Model",
      "receipt.laptopSerialN": "Sériové Číslo Laptopu",
      "receipt.warranty": "Záruka",
      "receipt.equipmentCheck": "Kontrola Zariadenia",
      "receipt.equipmentObs": "Pozn. Zariadenie",
      "receipt.repairObs": "Pozn. Opravy",
      "receipt.services": "Služby",
      "receipt.problem": "Problém",
      "receipt.mobileCondition": "Stav Mobilu (Pri Príjme)",
      "receipt.price": "Rozpočet",
      "receipt.responsibleText": "SME ZODPOVEDNÍ ZA ASISTENCIU / OPRAVU POPISANÝCH ANOMÁLIÍ.",
      "receipt.storageTitle": "Podmienky Skladovania a Vyzvednutia",
      "receipt.storageText1": "Zariadenie musí byť vyzdvihnuté do šesťdesiatich (60) dní po dokončení opravy a zodpovedajúcom oznámení od",
      "receipt.storageText2": "Po uplynutí tejto lehoty sa od 61. dňa účtuje poplatok za skladovanie vo výške 0,95 € denne, až do maximálneho limitu sto dvadsiatich (120) dní, platný bez ohľadu na to, či bola oprava vykonaná alebo či bol rozpočet zamietnutý.",
      "receipt.storageText3": "Prijatím tohto dokumentu klient vyhlasuje, že prečítal, pochopil a prijal podmienky a pravidlá opravy.",
      "receipt.repairReference": "Odkaz na Opravu",
      "receipt.cutHere": "REZTE TU",
      "common.yes": "Áno",
      "common.no": "Nie",
      "form.warrantyUntil30Days": "Záruka do 30 dní",
      "form.withoutWarranty": "Bez Záruky",
      "form.simCard": "SIM Karta",
      "form.simTray": "SIM Zásobník",
      "form.memoryCard": "Pamäťová Karta",
      "form.charger": "Nabíjačka",
      "form.battery": "Batéria",
      "form.waterDamaged": "Poškodené Vodou",
      "form.price": "Cena",
      "form.budget": "Rozpočet",
      "receipt.withoutIVA": "Bez DPH",
    },
    sl: {
      ...
      "receipt.adminCopy": "KOPIJA SKRBNIKA",
      "receipt.clientId": "ID Stranke",
      "receipt.name": "Ime",
      "receipt.clientPhone": "Telefon Stranke",
      "receipt.receivedBy": "Naprava Prejeta Od",
      "receipt.entryDate": "Datum Vstopa",
      "receipt.outDate": "Datum Izhoda",
      "receipt.repairN": "Popravilo n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Znamka-Model",
      "receipt.laptopSerialN": "Serijska Številka Prenosnega Računalnika",
      "receipt.warranty": "Garancija",
      "receipt.equipmentCheck": "Preverjanje Opreme",
      "receipt.equipmentObs": "Oprema Op.",
      "receipt.repairObs": "Popravilo Op.",
      "receipt.services": "Storitve",
      "receipt.problem": "Težava",
      "receipt.mobileCondition": "Stanje Mobilnega (Pri Prihodu)",
      "receipt.price": "Proračun",
      "receipt.responsibleText": "ODGOVORNI SMO ZA POMOČ / POPRAVILO OPISANIH ANOMALIJ.",
      "receipt.storageTitle": "Pogoji Shranjevanja in Prevzema",
      "receipt.storageText1": "Oprema mora biti prevzeta v roku šestdesetih (60) dni po zaključku popravila in ustreznem obvestilu od",
      "receipt.storageText2": "Po preteku tega roka se bo od 61. dneva zaračunavala pristojbina za shranjevanje v višini 0,95 € na dan, do največje omejitve sto dvajset (120) dni, uporabna neodvisno od tega, ali je bilo popravilo izvedeno ali je bil proračun zavrnjen.",
      "receipt.storageText3": "S sprejetjem tega dokumenta stranka izjavlja, da je prebrala, razumela in sprejela pogoje in pravila popravila.",
      "receipt.repairReference": "Sklic na Popravilo",
      "receipt.cutHere": "REŽITE TU",
      "common.yes": "Da",
      "common.no": "Ne",
      "form.warrantyUntil30Days": "Garancija do 30 dni",
      "form.withoutWarranty": "Brez Garancije",
      "form.simCard": "SIM Kartica",
      "form.simTray": "SIM Predal",
      "form.memoryCard": "Pomnilniška Kartica",
      "form.charger": "Polnilec",
      "form.battery": "Baterija",
      "form.waterDamaged": "Poškodovano z Vodo",
      "form.price": "Cena",
      "form.budget": "Proračun",
    ...
    lt: {
      ...
      "receipt.adminCopy": "ADMIN KOPIJA",
      "receipt.clientId": "Kliento ID",
      "receipt.name": "Vardas",
      "receipt.clientPhone": "Kliento Telefonas",
      "receipt.receivedBy": "Įrenginys Gautas Nuo",
      "receipt.entryDate": "Įėjimo Data",
      "receipt.outDate": "Išėjimo Data",
      "receipt.repairN": "Remontas n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Prekės Ženklas-Modelis",
      "receipt.laptopSerialN": "Nešiojo Kompiuterio Serijos Numeris",
      "receipt.warranty": "Garantija",
      "receipt.equipmentCheck": "Įrangos Patikra",
      "receipt.equipmentObs": "Įranga Past.",
      "receipt.repairObs": "Remontas Past.",
      "receipt.services": "Paslaugos",
      "receipt.problem": "Problema",
      "receipt.mobileCondition": "Mobiliojo Būklė (Atvykstant)",
      "receipt.price": "Biudžetas",
      "receipt.responsibleText": "MES ESAME ATSAKINGI UŽ PADĖTĮ / REMONTĄ APRAŠYTŲ ANOMALIJŲ.",
      "receipt.storageTitle": "Saugojimo ir Paėmimo Sąlygos",
      "receipt.storageText1": "Įranga turi būti paimta per šešiasdešimt (60) dienų po remonto užbaigimo ir atitinkamo pranešimo nuo",
      "receipt.storageText2": "Po šio termino pabaigos nuo 61 dienos bus taikomas saugojimo mokestis 0,95 € per dieną, iki maksimalaus šimto dvidešimt (120) dienų limito, taikomas nepriklausomai nuo to, ar remontas buvo atliktas, ar biudžetas buvo atmestas.",
      "receipt.storageText3": "Priimdamas šį dokumentą, klientas pareiškia, kad perskaitė, suprato ir priėmė remonto sąlygas ir taisykles.",
      "receipt.repairReference": "Remonto Nuoroda",
      "receipt.cutHere": "KIRPKITE ČIA",
      "common.yes": "Taip",
      "common.no": "Ne",
      "form.warrantyUntil30Days": "Garantija iki 30 dienų",
      "form.withoutWarranty": "Be Garantijos",
      "form.simCard": "SIM Kortelė",
      "form.simTray": "SIM Dėžutė",
      "form.memoryCard": "Atminties Kortelė",
      "form.charger": "Įkroviklis",
      "form.battery": "Baterija",
      "form.waterDamaged": "Pažeistas Vandens",
      "form.price": "Kaina",
    ...
    lv: {
      ...
      "receipt.adminCopy": "ADMIN KOPIJA",
      "receipt.clientId": "Klienta ID",
      "receipt.name": "Vārds",
      "receipt.clientPhone": "Klienta Telefons",
      "receipt.receivedBy": "Ierīce Saņemta No",
      "receipt.entryDate": "Ieejas Datums",
      "receipt.outDate": "Izejas Datums",
      "receipt.repairN": "Remonts n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Zīmols-Modelis",
      "receipt.laptopSerialN": "Klēpjdatora Sērijas Numurs",
      "receipt.warranty": "Garantija",
      "receipt.equipmentCheck": "Aprīkojuma Pārbaude",
      "receipt.equipmentObs": "Aprīkojums Piez.",
      "receipt.repairObs": "Remonts Piez.",
      "receipt.services": "Pakalpojumi",
      "receipt.problem": "Problēma",
      "receipt.mobileCondition": "Mobilā Stāvoklis (Ierodoties)",
      "receipt.price": "Budžets",
      "receipt.responsibleText": "MĒS ESAM ATBILDĪGI PAR PALĪDZĪBU / REMONTU APRAKSTĪTĀM ANOMĀLIJĀM.",
      "receipt.storageTitle": "Uzglabāšanas un Saņemšanas Nosacījumi",
      "receipt.storageText1": "Aprīkojums jāsaņem sešdesmit (60) dienu laikā pēc remonta pabeigšanas un atbilstoša paziņojuma no",
      "receipt.storageText2": "Pēc šī termiņa beigām no 61. dienas tiks piemērota uzglabāšanas maksa 0,95 € dienā, līdz maksimālajam ierobežojumam simts divdesmit (120) dienas, piemērojama neatkarīgi no tā, vai remonts ir veikts vai budžets ir noraidīts.",
      "receipt.storageText3": "Pieņemot šo dokumentu, klients apliecina, ka ir izlasījis, sapratis un pieņēmis remonta nosacījumus un noteikumus.",
      "receipt.repairReference": "Remonta Atsauce",
      "receipt.cutHere": "GRIEZT ŠEIT",
      "common.yes": "Jā",
      "common.no": "Nē",
      "form.warrantyUntil30Days": "Garantija līdz 30 dienām",
      "form.withoutWarranty": "Bez Garantijas",
      "form.simCard": "SIM Karte",
      "form.simTray": "SIM Lāde",
      "form.memoryCard": "Atmiņas Karte",
      "form.charger": "Uzlādes Ierīce",
      "form.battery": "Baterija",
      "form.waterDamaged": "S bojāts ar Ūdeni",
      "form.price": "Cena",
      "form.budget": "Budžets",
    ...
    et: {
      ...
      "receipt.adminCopy": "ADMIN KOOPIA",
      "receipt.clientId": "Klienti ID",
      "receipt.name": "Nimi",
      "receipt.clientPhone": "Klienti Telefon",
      "receipt.receivedBy": "Seade Vastu Võetud",
      "receipt.entryDate": "Sisendkuupäev",
      "receipt.outDate": "Väljakuupäev",
      "receipt.repairN": "Remont n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Bränd-Mudel",
      "receipt.laptopSerialN": "Sülearvuti Seerianumber",
      "receipt.warranty": "Garantii",
      "receipt.equipmentCheck": "Seadmete Kontroll",
      "receipt.equipmentObs": "Seadmed Märk.",
      "receipt.repairObs": "Remont Märk.",
      "receipt.services": "Teenused",
      "receipt.problem": "Probleem",
      "receipt.mobileCondition": "Mobiili Seisund (Saabumisel)",
      "receipt.price": "Eelarve",
      "receipt.responsibleText": "ME OLEME VASTUTAVAD KIRJELDATUD ANOMAALIATE ABISTAMISE / REMONDI EEST.",
      "receipt.storageTitle": "Hoiustamise ja Võtmise Tingimused",
      "receipt.storageText1": "Seade tuleb võtta kuuekümne (60) päeva jooksul pärast remondi lõpetamist ja vastavat teavitust",
      "receipt.storageText2": "Pärast selle tähtaja möödumist rakendatakse alates 61. päevast hoiustamistasu 0,95 € päevas, kuni maksimaalse piirini sada kakskümmend (120) päeva, rakendatav sõltumata sellest, kas remont on tehtud või eelarve on tagasi lükatud.",
      "receipt.storageText3": "Selle dokumendi vastuvõtmisel kinnitab klient, et on lugenud, mõistnud ja nõustunud remonditingimuste ja reeglitega.",
      "receipt.repairReference": "Remondi Viide",
      "receipt.cutHere": "LÕIGA SIIN",
      "common.yes": "Jah",
      "common.no": "Ei",
      "form.warrantyUntil30Days": "Garantii kuni 30 päevani",
      "form.withoutWarranty": "Ilma Garantiita",
      "form.simCard": "SIM Kaart",
      "form.simTray": "SIM Karp",
      "form.memoryCard": "Mälukaart",
      "form.charger": "Laadija",
      "form.battery": "Aku",
      "form.waterDamaged": "Vee Poolt Kahjustatud",
      "form.price": "Hind",
      "form.budget": "Eelarve",
    ...
    ga: {
      ...
      "receipt.adminCopy": "CÓIP RIAIRACH",
      "receipt.clientId": "ID Cliant",
      "receipt.name": "Ainm",
      "receipt.clientPhone": "Fón Cliant",
      "receipt.receivedBy": "Gléas Fáilte Ó",
      "receipt.entryDate": "Dáta Iontrála",
      "receipt.outDate": "Dáta Amach",
      "receipt.repairN": "Deisiúchán n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Branda-Samhail",
      "receipt.laptopSerialN": "Uimhir Shraithe Laptop",
      "receipt.warranty": "Barántas",
      "receipt.equipmentCheck": "Seiceáil Trealaimh",
      "receipt.equipmentObs": "Trealamh Obs.",
      "receipt.repairObs": "Deisiúchán Obs.",
      "receipt.services": "Seirbhísí",
      "receipt.problem": "Fadhb",
      "receipt.mobileCondition": "Ríomhaire Glúine (Ag Teacht)",
      "receipt.price": "Buiséad",
      "receipt.responsibleText": "TÁIMID FREAGRACH AS CÚNAMH / DEISIÚCHÁN NA n-ANOMALACHTAÍ A CHUIRTEAR SÍOS.",
      "receipt.storageTitle": "Coinníollacha Stórála agus Tógála",
      "receipt.storageText1": "Ní mór an trealamh a thógáil laistigh de seasca (60) lá tar éis an deisiúcháin a chríochnú agus an fógra comhfhreagrach ó",
      "receipt.storageText2": "Tar éis an téarma seo a bheith caite, cuirfear táille stórála de 0,95 € in aghaidh an lae i bhfeidhm ón 61ú lá, go dtí teorainn uasta de chéad fiche (120) lá, infheidhmithe beag beann ar an deisiúchán a bheith déanta nó ar an mbuiséad a bheith diúltaithe.",
      "receipt.storageText3": "Trí an doiciméad seo a ghlacadh, dearbhaíonn an cliant go bhfuil sé léite, tuigte agus glacadh leis na téarmaí agus rialacha deisiúcháin.",
      "receipt.repairReference": "Tagairt Deisiúcháin",
      "receipt.cutHere": "GEARR ANSEO",
      "common.yes": "Tá",
      "common.no": "Níl",
      "form.warrantyUntil30Days": "Barántas go dtí 30 lá",
      "form.withoutWarranty": "Gan Barántas",
      "form.simCard": "Cárta SIM",
      "form.simTray": "Tráidire SIM",
      "form.memoryCard": "Cárta Cuimhne",
      "form.charger": "Luchtaitheoir",
      "form.battery": "Ceallraí",
      "form.waterDamaged": "Dochrachtaithe ag Uisce",
      "form.price": "Praghas",
      "form.budget": "Buiséad",
    ...
    mt: {
      ...
      "receipt.adminCopy": "KOPJA AMMINISTRATUR",
      "receipt.clientId": "ID Klijent",
      "receipt.name": "Isem",
      "receipt.clientPhone": "Telefon Klijent",
      "receipt.receivedBy": "Apparat Riċevut Minn",
      "receipt.entryDate": "Data Dħul",
      "receipt.outDate": "Data Ħruġ",
      "receipt.repairN": "Tiswija n",
      "receipt.imei": "IMEI",
      "receipt.brandModel": "Marka-Mudell",
      "receipt.laptopSerialN": "Numru tas-Serje tal-Laptop",
      "receipt.warranty": "Garanzija",
      "receipt.equipmentCheck": "Verifika ta' Tagħmir",
      "receipt.equipmentObs": "Tagħmir Oss.",
      "receipt.repairObs": "Tiswija Oss.",
      "receipt.services": "Servizzi",
      "receipt.problem": "Problema",
      "receipt.mobileCondition": "Kundizzjoni Mobbli (Meta Jasal)",
      "receipt.price": "Baġit",
      "receipt.responsibleText": "AHNA RESPONSABBLI GHALL-ASSISTENZA / TISWIJA TAL-ANOMALIJIET DESKRITTI.",
      "receipt.storageTitle": "Kundizzjonijiet ta' Ħażna u Ħruġ",
      "receipt.storageText1": "It-tagħmir għandu jitħalla fi żmien ta' sittin (60) jum wara li t-tiswija tkun tlestiet u n-notifika korrispondenti minn",
      "receipt.storageText2": "Wara li jgħaddi dan it-terminu, se jitapplika ħlas ta' ħażna ta' 0,95 € kuljum, mill-61 jum, sa limit massimu ta' mija u għoxrin (120) jum, applikabbli irrispettivament jekk it-tiswija saret jew il-baġit ġie rrifjutat.",
      "receipt.storageText3": "Bill-jakċetta dan id-dokument, il-klijent jiddikjara li qara, fehem u aċċetta t-termini u r-regoli tat-tiswija.",
      "receipt.repairReference": "Referenza Tiswija",
      "receipt.cutHere": "AQTA' HAWN",
      "common.yes": "Iva",
      "common.no": "Le",
      "form.warrantyUntil30Days": "Garanzija sa 30 jum",
      "form.withoutWarranty": "Bla Garanzija",
      "form.simCard": "Karta SIM",
      "form.simTray": "Trojja SIM",
      "form.memoryCard": "Karta ta' Memorja",
      "form.charger": "Ċarġatur",
      "form.battery": "Batterija",
      "form.waterDamaged": "Immiddel minn Ilma",
      "form.price": "Prezz",
      "form.budget": "Baġit",
...
/**
 * Detect printer page size automatically using CSS @media print and page size detection
 * 
 * Detection Strategy:
 * 1. Uses CSS @media print to check printable area width
 * 2. Checks if printer supports A4 (210mm x 297mm) or larger sizes
 * 3. A4 width at 96dpi ≈ 794px, Letter ≈ 816px, Legal ≈ 816px
 * 4. Thermal printers typically have width < 400px (58mm ≈ 220px, 80mm ≈ 302px)
 * 
 * Rules:
 * - A4 or larger (A4, Letter, Legal, etc.) = "a4" (large printer)
 * - Smaller than A4 (thermal, 58mm, 80mm, small POS) = "thermal" (small printer)
 * - If detection fails, defaults to "thermal" (small printer) for safety
 * 
 * @returns Promise resolving to "a4" for large printers or "thermal" for small printers
 */
async function detectPrinterType(): Promise<"thermal" | "a4"> {
  return new Promise((resolve) => {
    try {
      // Method 1: Use CSS @media print to detect printable area
      // Create a hidden iframe to test print media queries
      ...
      testIframe.onload = () => {
        try {
          ...
          // Create test element with A4 dimensions
          ...
          const computed = iframeDoc.defaultView?.getComputedStyle(testDiv)
          if (!computed) {
          ...
          // Letter width ≈ 816px
          // Legal width ≈ 816px
          // Thermal printers: 58mm ≈ 220px, 80mm ≈ 302px
          // Threshold: If width > 600px, likely A4 or larger
          if (widthPx > 600) {
            console.log(`[detectPrinterType] ✅ Detected LARGE printer (A4 or larger) - width: ${widthPx.toFixed(2)}px`)
            resolve("a4")
          } else {
            console.log(`[detectPrinterType] ✅ Detected SMALL printer (thermal/small) - width: ${widthPx.toFixed(2)}px`)
            resolve("thermal")
          }
        } catch (error) {
          // Clean up on error
      ...
      // Set iframe content to trigger load
      ...
      setTimeout(() => {
        if (document.body.contains(testIframe)) {
          document.body.removeChild(testIframe)
          // Fallback: Use direct measurement method
          try {
            ...
            if (widthPx > 600) {
              console.log(`[detectPrinterType] ✅ Fallback: Detected LARGE printer - width: ${widthPx.toFixed(2)}px`)
              resolve("a4")
            } else {
              console.log(`[detectPrinterType] ✅ Fallback: Detected SMALL printer - width: ${widthPx.toFixed(2)}px`)
              resolve("thermal")
            }
          } catch (fallbackError) {
            console.warn("[detectPrinterType] ⚠️ Detection failed, defaulting to SMALL printer (thermal):", fallbackError)
            resolve("thermal") // Default to small printer for safety
          }
        }
      }, 1000)
      
    } catch (error) {
      console.warn("[detectPrinterType] ⚠️ Detection failed, defaulting to SMALL printer (thermal):", error)
      resolve("thermal") // Default to small printer if detection fails
    }
  })
}
...
/**
 * Main receipt printing function with automatic printer size detection
 * 
 * This function automatically detects printer page size and formats receipts accordingly:
 * - A4 or larger printers: Prints both Admin and Client copies on ONE page (top/bottom split)
 * - Small printers (thermal): Prints TWO separate receipts automatically (sequential printing)
 * 
 * @param tickets - Array of ticket objects to print
 * @param preferredPrinter - Optional printer name (for display only, not used for detection)
 * @param language - Receipt language (en, es, pt, etc.)
 * @param printerType - Printer type: "auto" (automatic detection), "a4" (force A4), or "thermal" (force thermal)
...
export async function printReceiptForTickets(
  ...
  // Auto-detect printer type if "auto" is specified (default behavior)
  let finalPrinterType: "thermal" | "a4"
  if (printerType === "auto") {
    console.log("[printReceiptForTickets] Auto-detecting printer size...")
    finalPrinterType = await detectPrinterType()
    console.log(`[printReceiptForTickets] ✅ Detected printer type: ${finalPrinterType}`)
  } else {
    finalPrinterType = printerType
    console.log(`[printReceiptForTickets] Using forced printer type: ${finalPrinterType}`)
  }
  ...
  const titleFontSize = finalPrinterType === "thermal" ? "16px" : "14px"
  const smallFontSize = finalPrinterType === "thermal" ? "12px" : "11px"
  const headerFontSize = finalPrinterType === "thermal" ? "15px" : "13px"
    ...
    return `
      <div style="font-family: Arial, sans-serif; width: 100% !important; font-size: ${baseFontSize}; line-height: ${lineHeight}; page-break-inside: avoid !important; page-break-after: avoid !important; page-break-before: avoid !important; break-inside: avoid !important; break-after: avoid !important; break-before: avoid !important; margin: 0; padding: 0;">
        <div style="display: ${finalPrinterType === "thermal" ? "block" : "table"}; width: 100% !important; margin: 0 0 4px 0; border-bottom: 1.5px solid #000; padding: 0 0 2px 0; page-break-inside: avoid;">
          <div style="display: ${finalPrinterType === "thermal" ? "block" : "table-row"};">
            <div style="display: ${cellLayout}; width: ${cellWidth}; vertical-align: top; padding-right: ${finalPrinterType === "thermal" ? "0" : "6px"}; margin-bottom: ${finalPrinterType === "thermal" ? "4px" : "0"};">
              ...
              ${companyPhone1 && companyPhone1 !== "N/A" ? `<div style="margin: 0; padding: 0; font-size: ${smallFontSize}; color: #000; line-height: ${lineHeight}; font-weight: normal;">${companyPhone1}</div>` : ""}
            </div>
            ...
            if (tickets.length > 1) {
              ...
              return `
                <div style="margin: 6px 0; padding: 5px 0; border-bottom: 1.5px solid #ccc; background-color: #f5f5f5; page-break-inside: avoid;">
                  ...
                  <div style="margin: 2px 0; padding: 1px 0; font-size: ${baseFontSize}; line-height: ${lineHeight};"><span style="font-weight: bold;">${t["receipt.warranty"]}:</span> <span style="font-weight: normal; color: #000;">${ticketWarrantyText}</span></div>
                  <div style="margin: 2px 0; padding: 1px 0; font-size: ${baseFontSize}; line-height: ${lineHeight};"><span style="font-weight: bold;">${priceLabel}:</span> <span style="font-weight: normal; color: #000;">€${ticketPrice}</span></div>
                </div>
              `
            }
          })()}
        ...
        <div style="margin: 8px 0; padding: 6px; background-color: #f0f0f0; text-align: center; font-weight: bold; font-size: ${headerFontSize}; border: 1px solid #ddd; page-break-inside: avoid;">
          <div style="font-size: ${headerFontSize}; font-weight: bold;">${totalLabel}: <span style="font-weight: normal; color: #000;">€${totalPrice.toFixed(2)}</span></div>
        </div>
        ...
        <div style="margin-top: 6px; padding: 6px; background-color: #f9f9f9; font-size: ${smallFontSize}; line-height: 1.5; border: 1px solid #ddd; page-break-inside: avoid; font-weight: normal; color: #000;">
          <div style="text-align: justify; margin-bottom: 4px; font-size: ${smallFontSize}; font-weight: normal; color: #000;">
  ...
  const generateReceiptHTML = (ticket: any, copyType: 'CLIENT' | 'ADMIN' = 'CLIENT') => {
    ...
    // Translate phoneIssue to selected receipt language
    const ticketPhoneIssue = ticket.phoneIssue && ticket.phoneIssue.trim() !== "" 
      ? (translateProblemForReceipt(ticket.phoneIssue, language) || ticket.phoneIssue)
      : null
    ...
    if (finalPrinterType === "thermal") {
      ...
      <div style="font-family: Arial, sans-serif; width: 58mm; max-width: 58mm; margin: 0 auto; padding: 2mm 0; background: white; color: black; font-size: 14px; line-height: 1.3; letter-spacing: 0.5px; page-break-inside: avoid !important; page-break-after: avoid !important; page-break-before: avoid !important; break-inside: avoid !important; break-after: avoid !important; break-before: avoid !important; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; text-rendering: optimizeLegibility;">
        ...
        ${companyAddress ? `<div style="text-align: center; font-size: 13px; font-weight: bold; color: #000; margin-bottom: 2px; padding: 0;">${companyAddress}</div>` : ""}
        ${companyPhone1 && companyPhone1 !== "N/A" ? `<div style="text-align: center; font-size: 13px; font-weight: bold; color: #000; margin-bottom: 3px; padding: 0;">${companyPhone1}</div>` : ""}
        ${companyEmail ? `<div style="text-align: center; font-size: 12px; font-weight: bold; color: #000; margin-bottom: 2px; padding: 0;">${companyEmail}</div>` : ""}
        ${companyWebsite ? `<div style="text-align: center; font-size: 12px; font-weight: bold; color: #000; margin-bottom: 3px; padding: 0;">${companyWebsite}</div>` : ""}
        ...
        <div style="text-align: right; font-size: 13px; margin-bottom: 2px; padding: 0;">
          <span style="font-weight: bold;">${t["receipt.clientId"]}:</span> <span style="font-weight: normal; color: #000;">${ticketClientId}</span>
        </div>
        <div style="text-align: right; font-size: 13px; margin-bottom: 2px; padding: 0;">
        ...
        <!-- IMEI -->
        <div style="font-size: 13px; margin-bottom: 2px; padding: 0;">
          <span style="font-weight: bold;">${t["receipt.imei"]}:</span> <span style="font-weight: normal; color: #000;">${ticketImeiNo}</span>
        </div>
        
        <!-- Brand & Model -->
        <div style="font-size: 13px; margin-bottom: 2px; padding: 0;">
          <span style="font-weight: bold;">${t["receipt.brandModel"]}:</span> <span style="font-weight: normal; color: #000;">${ticketBrand} - ${ticketModel}</span>
        </div>
...
Chg:${ticketCharger.padEnd(4)} Bat:${ticketBattery.padEnd(4)} Water:${ticketWaterDamaged}
        ...
        <!-- Disclaimer Title -->
        <div style="text-align: center; font-weight: bold; font-size: 13px; margin-bottom: 2px; padding: 0;">
          ${t["receipt.storageTitle"]}
        </div>
        
        <!-- Disclaimer Text -->
        <div style="font-size: 11px; line-height: 1.4; margin-top: 2px; padding: 0; text-align: left; font-weight: normal; color: #000;">
          ${t["receipt.storageText1"]}<br/>
          ${t["receipt.storageText2"]}<br/>
          ${t["receipt.storageText3"]}
        </div>
        
        <!-- Bottom Spacing -->
        <div style="height: 5mm; margin: 0; padding: 0;"></div>
      </div>
      `
    }
    ...
    return `
      <div style="font-family: Arial, sans-serif; width: 100% !important; font-size: ${baseFontSize}; line-height: ${lineHeight}; page-break-inside: avoid !important; page-break-after: avoid !important; page-break-before: avoid !important; break-inside: avoid !important; break-after: avoid !important; break-before: avoid !important; margin: 0; padding: 0; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; text-rendering: optimizeLegibility;">
        ...
        <div style="margin-top: 6px; padding: 6px; background-color: #f9f9f9; font-size: ${smallFontSize}; line-height: 1.5; border: 1px solid #ddd; font-weight: normal; color: #000;">
          <div style="text-align: justify; margin-bottom: 4px; font-size: ${smallFontSize}; font-weight: normal; color: #000;">
            ${t["receipt.storageText1"]}
          </div>
          <div style="text-align: justify; margin-bottom: 4px; font-size: ${smallFontSize}; font-weight: normal; color: #000;">
  ...
  if (finalPrinterType === "a4") {
    ...
    ticketsHTML = Object.values(finalGroupedTickets).map(ticketGroup => {
      ...
      // A4 Single receipt - full width, no margins
      return `
        <div class="a4-receipt" style="width: 100% !important; page-break-inside: avoid !important; padding: 0 !important; margin: 0 !important; box-sizing: border-box;">
          ${receipt}
        </div>
      `
    }).join("")
    ...
    ticketsHTML = Object.values(finalGroupedTickets).map(ticketGroup => {
      ...
      // Thermal: Single receipt - full width, no margins
      return `
        <div class="thermal-receipt" style="width: 100% !important; page-break-inside: avoid !important; margin: 0 !important; padding: 0 !important; box-sizing: border-box;">
          ${receipt}
        </div>
      `
    }).join("")
  ...
  const pageSize = finalPrinterType === "thermal" ? "58mm" : "A4"
  const pageMargin = "0"
  const bodyPadding = "0"
  const maxWidth = finalPrinterType === "thermal" ? "58mm" : "100%"
  const fontSize = finalPrinterType === "thermal" ? "12px" : "9pt"
          ...
          <style>
            ...
            @media print {
              ...
              * {
              ...
              html, body {
                overflow: ${finalPrinterType === "thermal" ? "hidden" : "visible"};
                page-break-after: ${finalPrinterType === "thermal" ? "avoid" : "auto"};
                height: ${finalPrinterType === "thermal" ? "100vh" : "auto"};
              }
              ...
              .ticket-container {
                page-break-inside: avoid !important;
                page-break-after: ${finalPrinterType === "thermal" ? "always" : "avoid"} !important;
                page-break-before: avoid !important;
                break-inside: avoid !important;
                break-after: ${finalPrinterType === "thermal" ? "always" : "avoid"} !important;
  ...
  const waitForContentAndPrint = () => {
    try {
      ...
      if (readyState === "complete" && hasBodyContent) {
        ...
        console.log(`[printReceiptForTickets] ✅ Final printer type: ${finalPrinterType}`)
        console.log(`[printReceiptForTickets] 📋 Print behavior: ${finalPrinterType === "a4" ? "Single page with both copies (top/bottom)" : "Two separate receipts (sequential)"}`)
        printWindow.focus()
        
        if (finalPrinterType === "thermal") {
          // SMALL PRINTER (Thermal): Print TWO separate receipts automatically
          // Both receipts are in the document with page breaks
          ...
          console.log("[printReceiptForTickets] 🔵 SMALL PRINTER detected - both copies will print sequentially")
        ...
        setTimeout(() => {
          if (printWindow && !printWindow.closed && printWindow.document) {
            ...
            if (finalPrinterType === "thermal") {
              // SMALL PRINTER: Both receipts in document, will print sequentially
              console.log("[printReceiptForTickets] 🔵 Fallback: Printing two separate receipts (small printer)")
              printWindow.print()
              setTimeout(() => {
                if (printWindow && !printWindow.closed) {
                  printWindow.close()
              ...
              // LARGE PRINTER: Both copies on one page
              console.log("[printReceiptForTickets] 🟢 Fallback: Printing single page with both copies (large printer)")
              printWindow.print()
              setTimeout(() => {
                if (printWindow && !printWindow.closed) {
                  printWindow.close()
